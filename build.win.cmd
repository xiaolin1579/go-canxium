...
:build.canxium
    echo Building Canxium...
        echo Searching for old binaries and cleaning old cache...
         rmdir /s /q build\bin\
            go clean -cache
            go run build/ci.go install ./cmd/canxium
...
:build.all
    echo Building Canxium (ALL BINARIES)...
        echo Searching for old binaries and cleaning old cache...
            rmdir /s /q build\bin\
            go clean -cache
